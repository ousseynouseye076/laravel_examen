        ...
        <div class="card-body">
            <form class="needs-validation" method="POST" action="{{ route('user.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group mb-3">
                    ...
                    <input class="form-control" name="name" value="{{ old('name') }}" type="text" required id="name">
                    @error('name')
                        <span>{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <input class="form-control" name="prenom" value="{{ old('prenom') }}" type="text" required id="prenom">
                    @error('prenom')
                        <span>{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <input class="form-control" name="email" value="{{ old('email') }}" type="email" required id="email">
                    @error('email')
                        <span>{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <select name="role"  id='role' class="form-control" >
                        <option value="" selected disabled>Sectionner le role</option>
